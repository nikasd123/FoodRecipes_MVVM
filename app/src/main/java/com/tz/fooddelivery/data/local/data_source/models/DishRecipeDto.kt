...
data class DishRecipeDto(
    ...
    @SerializedName("strIngredient21") val ingredient21: String?,
    @SerializedName("strIngredient22") val ingredient22: String?,
    @SerializedName("strIngredient23") val ingredient23: String?,
    @SerializedName("strIngredient24") val ingredient24: String?,
    @SerializedName("strIngredient25") val ingredient25: String?,
    @SerializedName("strIngredient26") val ingredient26: String?,
    @SerializedName("strIngredient27") val ingredient27: String?,
    @SerializedName("strIngredient28") val ingredient28: String?,
    ...
    @SerializedName("strMeasure21") val measure21: String?,
    @SerializedName("strMeasure22") val measure22: String?,
    @SerializedName("strMeasure23") val measure23: String?,
    @SerializedName("strMeasure24") val measure24: String?,
    @SerializedName("strMeasure25") val measure25: String?,
    @SerializedName("strMeasure26") val measure26: String?,
    @SerializedName("strMeasure27") val measure27: String?,
    @SerializedName("strMeasure28") val measure28: String?,
) {
    fun toDomain(): MealRecipe {
        ...
        for (i in 1..20) {
            ...
            if (!ingredient.isNullOrBlank() && !measure.isNullOrBlank()) {
                ingredients.add(IngredientItem(translatedName = ingredient, translatedMeasure = measure))
            }
        }
