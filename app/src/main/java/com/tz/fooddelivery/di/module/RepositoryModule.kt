...
class RepositoryModule {
    ...
    @Provides
    fun provideDishesRepository(localDataSource: LocalDataSource, dishesDao: DishesDao): MealsRepository =
        MealsRepositoryImpl(localDataSource = localDataSource, dishesDao = dishesDao)
